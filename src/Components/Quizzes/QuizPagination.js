...
const QuizPagination = ({ currentPage, totalQuizzes, quizzesPerPage, onPageChange, }) => {
    const totalQuizzesSafe = totalQuizzes || 0;
    const totalPages = Math.max(1, Math.ceil(totalQuizzesSafe / quizzesPerPage));
